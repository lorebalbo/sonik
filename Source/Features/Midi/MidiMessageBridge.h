...
namespace sonik::midi
{
    ...
    inline constexpr std::array<RoutingClass, MidiTargetCategoryCount> routingTable = {
        ...
        /* PitchRangeCycle     */ RoutingClass::MessageThread,
        ...
        /* MasterGain          */ RoutingClass::MessageThread,
        /* HeadphonesGain      */ RoutingClass::MessageThread,
        /* HeadphoneCueToggle  */ RoutingClass::MessageThread,
        /* KeyLockToggle       */ RoutingClass::MessageThread,
        /* MasterTempoToggle   */ RoutingClass::MessageThread,
        /* KeyShiftPlus        */ RoutingClass::MessageThread,
        /* KeyShiftMinus       */ RoutingClass::MessageThread,
        ...
        /* HotCueDelete        */ RoutingClass::MessageThread,
        /* BeatJumpMinus       */ RoutingClass::MessageThread,
        /* BeatJumpPlus        */ RoutingClass::MessageThread,
        /* BeatJumpSizeCycle   */ RoutingClass::MessageThread,
        /* QuantizeToggle      */ RoutingClass::MessageThread,
        /* SlipToggle          */ RoutingClass::MessageThread,
        /* PositionSeek        */ RoutingClass::MessageThread,
