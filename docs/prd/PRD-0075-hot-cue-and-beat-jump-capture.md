...
- [ ] The jump event record enqueued on the audio thread (quantized cue case) is a fixed-size POD; enqueuing it performs no allocation, takes no lock, and does no I/O, per `CLAUDE.md` and EPIC-0009 §1.3.3.
